...
{\centering \includegraphics[width=0.1\linewidth]{figures/beltcrest} 
...
\hypertarget{subsection-title-2}{%
\section{Subsection title}\label{subsection-title-2}}

\hypertarget{subsection-title-3}{%
\section{SubSection title}\label{subsection-title-3}}

\hypertarget{methods-and-data}{%
\chapter{Methods and data}\label{methods-and-data}}

\hypertarget{subsection-title-4}{%
\section{Subsection title}\label{subsection-title-4}}
...
You can cite in this way\autocites{Shea2014}{Lottridge2012}.
Or this other way. \textcite{Shea2014} and \textcite{Lottridge2012} found that \ldots{}
...
{\centering \includegraphics[width=0.7\linewidth]{_main_files/figure-latex/codeChunkName-1} 
...
\section{Section title}\label{section-title-2}}

\hypertarget{results}{%
\chapter{Results}\label{results}}

\hypertarget{subsection-title-5}{%
\section{SubSection title}\label{subsection-title-5}}

Start writing and do your best.

\hypertarget{subsection-title-6}{%
\section{SubSection title}\label{subsection-title-6}}

\hypertarget{subsection-title-7}{%
\section{SubSection title}\label{subsection-title-7}}
