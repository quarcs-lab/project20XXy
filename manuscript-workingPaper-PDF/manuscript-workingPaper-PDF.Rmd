...
<!-- To input a latex table from file use: \input{../results/table.tex} -->

\input{"../results/tab-descriptiveStats.tex"}
...
## Import latex or html table from file
...
```{r codeChunkName, fig.cap="Title of the figure"}
ggplot(cars) +
  aes(x = speed, y = dist) +
  geom_point()
```
...
```{r codeChunkName2, fig.cap="Figure from png"}
include_graphics("../results/finalclubs_k_all.png")
```
