...
Regional inequality is a pervasive feature of the Indonesian economy \autocites{esmara1975regional}{mishra2009economic}{bendesa2016}.
...
First, there is a large literature that studies provincial income disparities in Indonesia \autocites{akita1988regional}{mishra2009economic}{akita2011structural}.
To this literature, this paper contributes an evaluation of provincial disparities in some of the main determinants of per-capita income: labor productivity, physical capital, human capital and efficiency.\footnote{By studying the determinants of income, this paper is also related to the literature that decomposes income differences into factors in Indonesia \autocites{akitaLukman1995}{kataoka2010factor}{kataoka2018inequality}.}
Second, there is a growing literature that studies provincial convergence with a focus on the dynamics of the ``average'' province that converges to a unique equilibrium \autocites{garcia1998differences}{resosudarmo2006regional}{vidyattama2013regional}.
...
Third, there is an emerging literature that studies provincial convergence in Indonesia from a convergence clubs perspective \autocites{gunawan2019provinces}{kurniawan2019poor}{mendez2020efficiencyConvergence}.
...
\hypertarget{other-subsection-2}{%
\subsection{Other subsection}\label{other-subsection-2}}
...
{\centering \includegraphics[width=0.7\linewidth]{manuscript-workingPaper_files/figure-latex/codeChunkName-1} 
...
This is a table that is nativaly created in this document using R

\begin{table}

\caption{\label{tab:unnamed-chunk-1}A knitr kable table}
\centering
\begin{tabular}[t]{r|r}
\hline
speed & dist\\
...
{\centering \includegraphics[width=0.7\linewidth]{other-figs/finalclubs_k_all} 
