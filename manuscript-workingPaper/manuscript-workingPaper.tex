...
\hypertarget{regression-table-in-plain-text}{%
\subsection{Regression table in plain text}\label{regression-table-in-plain-text}}
...
Log Likelihood -9.090\\
Akaike Inf. Crit. 26.200\\
Residual Std. Error 7.140 (df = 24) 6.860 (df = 26)\\
F Statistic 12.100*** (df = 5; 24) 21.700*** (df = 3; 26)\\
=============================================================================
